...
event: 'ACMG Educational  Webinar Series: Tranlsating Genes into Health'
event_url: 
location: Recorded
address:
  street: 
...
summary: This ACMG webinar focuss on treatabel metabolic disorders 
...
This session explores the essential functions of vitamins—particularly B vitamins—as metabolic cofactors and their significance in maintaining health. Through a series of case-based examples, we will examine how vitamin deficiencies can mimic inherited metabolic disorders (IMDs), and how supratherapeutic dosing of select B vitamins can be employed as targeted therapies. We will begin with an overview of the biochemical roles of vitamins, with an emphasis on their cofactor activity, followed by detailed case studies:
